...
namespace AppC_ {
    ...
    public partial class dataSetUsers : global::System.Data.DataSet {
        ...
        public partial class usersDataTable : global::System.Data.TypedTableBase<usersRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")]
            public usersRow AddusersRow(string login, string password, int role, string phone) {
...
namespace AppC_.dataSetUsersTableAdapters {
    ...
    public partial class usersTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.InsertCommand.CommandText = "INSERT INTO [dbo].[users] ([login], [password], [role], [phone]) VALUES (@login, " +
                "@password, @role, @phone);\r\nSELECT id, login, password, role, phone FROM users W" +
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE [dbo].[users] SET [login] = @login, [password] = @password, [role] = @role, [phone] = @phone WHERE (([id] = @Original_id) AND ([login] = @Original_login) AND ([password] = @Original_password) AND ([role] = @Original_role) AND ([phone] = @Original_phone));
SELECT id, login, password, role, phone FROM users WHERE (id = @id)";
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT id, login, password, role, phone FROM dbo.users";
        ...
        public virtual int Delete(int Original_id, string Original_login, string Original_password, int Original_role, string Original_phone) {
        ...
        public virtual int Insert(string login, string password, int role, string phone) {
            if ((login == null)) {
        ...
        public virtual int Update(string login, string password, int role, string phone, int Original_id, string Original_login, string Original_password, int Original_role, string Original_phone, int id) {
            if ((login == null)) {
                throw new global::System.ArgumentNullException("login");
            }
            else {
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(string login, string password, int role, string phone, int Original_id, string Original_login, string Original_password, int Original_role, string Original_phone) {
            return this.Update(login, password, role, phone, Original_id, Original_login, Original_password, Original_role, Original_phone, Original_id);
        }
    }
