...
namespace AppC_ {
    ...
    public partial class DataSetProducts : global::System.Data.DataSet {
        ...
        public partial class productsDataTable : global::System.Data.TypedTableBase<productsRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")]
            public productsRow AddproductsRow(string name, string category, double price, string city, System.DateTime date, int userId) {
        ...
        public partial class productsRow : global::System.Data.DataRow {
            ...
            public string city {
                get {
                    return ((string)(this[this.tableproducts.cityColumn]));
                }
                set {
                    this[this.tableproducts.cityColumn] = value;
                }
            }
...
namespace AppC_.DataSetProductsTableAdapters {
    ...
    public partial class productsTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = "DELETE FROM [dbo].[products] WHERE (([id] = @Original_id) AND ([name] = @Original" +
                "_name) AND ([category] = @Original_category) AND ([price] = @Original_price) AND" +
                " ([city] = @Original_city) AND ([date] = @Original_date) AND ([userId] = @Origin" +
                "al_userId))";
            ...
            this._adapter.InsertCommand.CommandText = "INSERT INTO [dbo].[products] ([name], [category], [price], [city], [date], [userI" +
                "d]) VALUES (@name, @category, @price, @city, @date, @userId);\r\nSELECT id, name, " +
                "category, price, city, date, userId FROM products WHERE (id = SCOPE_IDENTITY())";
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE [dbo].[products] SET [name] = @name, [category] = @category, [price] = @price, [city] = @city, [date] = @date, [userId] = @userId WHERE (([id] = @Original_id) AND ([name] = @Original_name) AND ([category] = @Original_category) AND ([price] = @Original_price) AND ([city] = @Original_city) AND ([date] = @Original_date) AND ([userId] = @Original_userId));
SELECT id, name, category, price, city, date, userId FROM products WHERE (id = @id)";
        ...
        private void InitConnection() {
            ...
            this._connection.ConnectionString = global::AppC_.Properties.Settings.Default.C_ProjectConnectionString;
        }
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT id, name, category, price, city, date, userId FROM dbo.products";
        ...
        public virtual int Delete(int Original_id, string Original_name, string Original_category, double Original_price, string Original_city, System.DateTime Original_date, int Original_userId) {
        ...
        public virtual int Insert(string name, string category, double price, string city, System.DateTime date, int userId) {
            if ((name == null)) {
        ...
        public virtual int Update(string name, string category, double price, string city, System.DateTime date, int userId, int Original_id, string Original_name, string Original_category, double Original_price, string Original_city, System.DateTime Original_date, int Original_userId, int id) {
            if ((name == null)) {
                throw new global::System.ArgumentNullException("name");
            }
            else {
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(string name, string category, double price, string city, System.DateTime date, int userId, int Original_id, string Original_name, string Original_category, double Original_price, string Original_city, System.DateTime Original_date, int Original_userId) {
            return this.Update(name, category, price, city, date, userId, Original_id, Original_name, Original_category, Original_price, Original_city, Original_date, Original_userId, Original_id);
        }
    }
